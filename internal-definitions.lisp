...
(defun expand-partially (self form)
  (cond ((atom form)
         (step-expansion self form))
        ((member (car form) '(setf setq)) form)
        (t (expand-partially-1 self form))))

(define-env-method expand-partially-1 (self form)
  ...
  (if (atom form) (step-expansion self form)
      (if (member (car form) '(setf setq)) form
